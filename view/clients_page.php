...
<div class="wrap">
    ...
    <div class="tab-content">
        <?php if ($active_tab == 'view'): ?>
            <form id="searchClientsForm" method="get" action="" style="padding-top: 10px;">
                <p class="search-box">
                    <input type="hidden" name="page" value="quip-invoices-clients"/>
                    <input type="hidden" name="tab" value="<?php echo $active_tab; ?>"/>
                    <label class="screen-reader-text" for="post-search-input">Search Clients:</label>
...
<!-- dialog -->
<div id="deleteClientDialog" title="<?php _e('Delete Client?', 'quip-invoices'); ?>" style="display:none;">
