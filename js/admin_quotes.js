/**
 * @notes: Just a slightly cut down/modified version of admin_invoices.js.
...
jQuery(document).ready(function ($)
{
    ...
    $('.copy-invoice').click(function (e)
    {
        ...
        $.ajax({
            type: "POST",
            url: quip_invoices.ajaxurl,
            data: {"action": "quip_invoices_copy_quote", "id": id},
            cache: false,
            dataType: "json",
            success: function (data)
            {
    ...
    // convert to an invoice, from the quotes list
    $('.convert-invoice').click(function (e)
    {
        e.preventDefault();
        $loading.show();
        ...
        $.ajax({
            type: "POST",
            url: quip_invoices.ajaxurl,
            data: {"action": "quip_invoices_convert_quote", "id": id},
            cache: false,
            dataType: "json",
            success: function (data)
            {
                $loading.hide();
                fsa_showUpdate(quip_invoices.strings.invoiceMsgConverted);
    ...
    function delete_invoice()
    {
        ...
        $.ajax({
            type: "POST",
            url: quip_invoices.ajaxurl,
            data: {"action": "quip_invoices_delete_quote", "id": id},
            cache: false,
            dataType: "json",
            success: function (data)
            {
