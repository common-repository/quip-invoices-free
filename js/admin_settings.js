jQuery(document).ready(function ($)
{
    ...
    $('#quip-invoices-notification-settings-form').submit(function ()
    {
        fsa_clearUpdateAndError();
        var $form = $(this);
        //post form via ajax
    ...
    $('#processorStripe').click(function()
    {
        $('.paymentSettingsSection').hide();
        $('#stripePaymentSettings').show();
    });

    $('#processorPaypal').click(function()
    {
        $('.paymentSettingsSection').hide();
        $('#paypalPaymentSettings').show();
    });
